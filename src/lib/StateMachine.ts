import { MachineNotStartedError, StateNotFoundError, TransitionDeniedError } from './errors.js';
import type { IState, IStateMachine, StateChangeEvent, StateMachineConfig } from './interfaces.js';
